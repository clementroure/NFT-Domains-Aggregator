...
const VIDEOS_DEMO: VideoType[] = [
  {
    ...
    thumbnail:
      "https://images.unsplash.com/photo-1644143379190-08a5f055de1d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1064&q=80",
  },
];
...
const SectionVideos: FC<SectionVideosProps> = ({
  ...
  const renderMainVideo = () => {
    ...
    return (
      ...
      >
        {isPlay ? (
          <iframe
            src={`https://www.youtube.com/embed/${video.id}?autoplay=1&end=105${isSafariBrowser() ? "&mute=1" : ""}`}
            title={video.title}
  ...
  return (
    <div className={`nc-SectionVideos ${className}`}>
      <Heading
        desc="Learn more about the possibilities offered by this new technology."
      >
        🎬 Why do I need one ?
      </Heading>
